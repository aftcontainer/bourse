$(document).ready(function () {
            // --- DataTable + recherche ---
            var table = document.getElementById("kt_qualites_table");
            ...
            $(".editBtn").on("click", function(){
                $("#editQualiteForm input[name='libelle']").val($(this).data("libelle"));
                $("#editQualiteForm input[name='id']").val($(this).data("id"));
            });

            $("#qualiteForm").on("submit",function(e){
            e.preventDefault();
            ...
            $("#editQualiteForm").on("submit",function(e){
                e.preventDefault();
                const url = $(this).data("url");
                $.ajax({
                    type: "post",
